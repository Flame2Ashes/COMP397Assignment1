...
module scenes {
    export class SHOVEL extends objects.Scene {
        ...
        public start() : void {
            ...
            this._gameLabel = new objects.Label("You gave your brother the shovel.", "30px Consolar", "#000000", config.Screen.CENTER_X, 30);
            ...
            this._gameLabel5 = new objects.Label("Which way do you go?", "40px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
